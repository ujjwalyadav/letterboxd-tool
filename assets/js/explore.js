...
function sortFilms(films) {
  ...
  const sorters = {
    ...
    "lb-rating-desc": (a,b) => (b.letterboxd_community?.average_rating ?? -1) - (a.letterboxd_community?.average_rating ?? -1),
    "lb-watches-desc": (a,b) => (b.letterboxd_community?.watches ?? -1) - (a.letterboxd_community?.watches ?? -1),
